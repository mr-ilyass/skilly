        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                ...
                <div class="card" style="background-color: #dae1e7 ; opacity: 0.8">
                    <div class="card-header" style="background-color: #f0f0f0 ;font-family: 'Microsoft Sans Serif'">
                        Subscribe  In Premium Service
                        <div style="float: right">
                            <form action="{{route('checkoutCoupon',$id)}}" method="post">
                                <input type="hidden" name="_method" value="POST">
                                @csrf
                                <input type="text" id="fname" name="coupon" placeholder="coupon">
                            <button class="mt-2 btn btn-sm btn-primary" type="submit" style="margin-bottom: 8px ;">
                                check
                            </button>
                    ...
                    <div class="card-body">
                        ...
                        <select name="plan" class="form-control" id="subscription-plan">
                            @foreach($plans as $plan)
                                <option  value="{{$plan->plan_Key}}"> {{$plan->plan_Name}} --> {{$plan->Plan_Price}} M.A.D</option>
                            @endforeach
                        </select>
                            <br>
