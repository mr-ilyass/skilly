...
@section('content')
    <body data-aos-easing="ease" data-aos-duration="1500" data-aos-delay="0" class="body-scrolled">
    ...
    <!-- Header -->
    <header class="header header-inverse" style="background-image: url({{asset('privacy.jpg')}});" data-overlay="8">
        <div class="container text-center">
            ...
            <div class="row">
                <div class="col-12 col-lg-8 offset-lg-2">
                    ...
                    <p class="fs-20 opacity-70">Last update: April 20, 2020</p>
