...
<nav class="topbar topbar-sticky">
    <div class="container">
        ...
        <div class="topbar-right">
            @auth
            <a class="btn btn-sm btn-outline-warning mr-4" href="#">Welcome {{ Auth::user()->name }} </a>
            @else
            <a class="btn btn-sm btn-danger mr-4"  data-toggle="modal" data-target="#loginModal" href="#">Sign in / sign Up</a>
            @endif
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row align-items-center pt-3 pb-5">
                            ...
                            <div class="col text-right">
                                <p class="mb-0 fw-300"><a class="text-muted small-2" href="{{url('/password/reset')}}">Forgot password?</a></p>
                            </div>
                        </div>
        ...
        <div class="row gap-y align-items-center">
            <div class="col-12 col-lg-3">
                <p class="text-center text-lg-left">
                    <a href="{{route('home')}}"><img src="{{asset('SaaSassets/img/CustomBlack.png')}}" alt="logo"></a>
                </p>
            </div>
...
<div class="drawer">
    <div class="drawer-content">
        <ul class="nav nav-primary nav-hero flex-column">
            ...
            @endif
            @if(Auth::user()->hasRole('abonne|superadministrator|administrator'))
                <li class="nav-item">
