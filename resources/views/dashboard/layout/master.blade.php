            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
                    <a href="{{url('/dashboard/setting')}}" class="dropdown-item">
                        <p style="text-align: center"> Parametre  </p>
                    </a>
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="{{route('dashboard/users')}}" class="nav-link @if (\Request::is('dashboard/users'))active @endif ">
                            <i class="nav-icon fas fa-users-cog"></i>
                            <p>
                                {{trans('dashboardUsers.users')}}

                            </p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{route('dashboard/profs')}}" class="nav-link @if (\Request::is('dashboard/profs'))active @endif ">
                            <i class="nav-icon fas fa-chalkboard-teacher"></i>
                            <p>

                                {{trans('dashboardUsers.formateur')}}
                            </p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{route('dashboard/categories')}}" class="nav-link @if (\Request::is('dashboard/categories'))active @endif ">
                            <i class="nav-icon fab fa-buffer"></i>
                            <p>
                                {{trans('dashboardUsers.categories')}}
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link  @if (\Request::is('dashboard/course/create'))active  @elseif(\Request::is('dashboard/course/edit'))active
 @elseif(\Request::is('dashboard/course/*/Episode'))active @endif">
                            <i class="nav-icon fas fa-chart-pie"></i>
                            <p>
                                {{trans('dashboardUsers.cours')}}
                                <i class="right fas fa-angle-left"></i>
                            </p>
                        </a>
                        <ul class="nav nav-treeview" style="display: none;">
                            <li class="nav-item   ">
                                <a href="{{route('dashboard/createCourse')}}" class="nav-link @if (\Request::is('dashboard/course/create'))active @endif ">
                                    <i class="fas fa-plus nav-icon"></i>
                                    <p>Create course</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('dashboard/editcourse')}}" class="nav-link @if (\Request::is('dashboard/course/edit'))active
@elseif(\Request::is('dashboard/course/*/Episode'))active @endif ">
                    ...
                    <li class="nav-item">
                        <a href="{{route('dashboard/Coupons')}}" class="nav-link @if (\Request::is('dashboard/coupons'))active @endif ">
                            <i class="nav-icon fas fa-tags"></i>
                            <p>
                                {{trans('dashboardUsers.coupon')}}
