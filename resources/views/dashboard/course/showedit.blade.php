...
">
                ...
                <form action="{{route('dashboard/searchCourse')}}" method="post">
                    ...
                    <div class="row">
                        ...
                        <a href="{{route('dashboard/editcourse')}}"  class="btn btn-warning" style="margin-left: 5px; background-color: #f5b971;">
                                        ...
                                        @foreach($courses as $course)
                                            <tr role="row" class="odd">
                                                ...
                                                <td style="padding: 10px;">
                                                    <a href="{{route('dashboard/Editspecific',$course->id)}}"  class="btn  btn-warning">
                                                        <i class="fas fa-edit" ></i>
                                                    </a>
                                                </td>
                                                <td style="padding: 10px;">
                                                    <a href="{{route('dashboard/Episodes',[$course->id])}}"  class="btn  btn-success">
                                                ...
                                                <div class="modal fade" id="delete{{$course->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <form action="{{route('dashboard/deleteCourse',[$course->id])}}" method="post" >
